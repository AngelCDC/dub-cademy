...
export function EnrollmentButton({ courseId }: { courseId: string }) {
  ...
  return (
    <button
      onClick={onSubmit}
      disabled={pending}
      className="flex items-center justify-center gap-2 w-full bg-primary hover:bg-primary/90 disabled:opacity-50 text-white font-semibold text-sm py-3.5 [@media(max-height:860px)]:py-2.5 rounded-full transition-all hover:-translate-y-0.5 shadow-md shadow-primary/25"
    >
