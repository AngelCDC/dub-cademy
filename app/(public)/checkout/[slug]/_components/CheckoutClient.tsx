...
import { applyCouponAction, savePaymentReferenceAction } from "../actions";
import {
  Banknote,
  Book,
  Building2,
  ...
  function applyCoupon() {
    ...
    startApplying(async () => {
      const { data: result, error } = await tryCatch(
        applyCouponAction(slug, couponInput)
      );
        ...
        <div className="order-1 xl:order-2 bg-white border border-violet-100 rounded-2xl shadow-lg shadow-violet-100/50 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <p className="text-center text-xs text-slate-400 leading-relaxed">
              {isFree
                ? "Tu cupón cubre el 100% del curso. Un administrador revisará tu solicitud y activará tu acceso."
