...
export function DemoForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-white dark:bg-card border border-violet-100 rounded-2xl p-8 shadow-sm text-center">
        <div className="size-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
          <span className="text-2xl">⚡</span>
        </div>
        <h3 className="text-base font-bold text-ink mb-2">¡Solicitud recibida!</h3>
  ...
  return (
    <div className="bg-white dark:bg-card border border-violet-100 rounded-2xl p-8 shadow-sm">
      <h2 className="text-xl font-bold text-ink mb-1">Agenda una demo gratuita</h2>
